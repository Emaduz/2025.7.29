  ...
  const projects: Project[] = [
    {
      ...
      category: 'branding',
      image: ['https://mir-s3-cdn-cf.behance.net/project_modules/fs_webp/5d60ca214380481.675743f089720.jpeg'],
    ...
    },
    {
      ...
      category: 'logos',
      image: ['https://mir-s3-cdn-cf.behance.net/project_modules/fs_webp/60a714214380481.675743f084bea.jpeg'],
    ...
    },
    {
      ...
      category: 'branding',
      image: ['https://mir-s3-cdn-cf.behance.net/project_modules/fs_webp/3ae409214380481.675743f08c104.jpeg'],
      description: { en: 'Complete brand identity package for tech company', ar: 'حزمة هوية تجارية كاملة لشركة تقنية' },
      tags: ['branding', 'Logo', 'Guidelines'],
    },
    {
      id: 4,
      title: { en: 'Jawaher Al Alamia Exchange', ar: 'تصميم شعار جواهر العالمية للصرافة' },
      category: 'logos',
      image: ['https://mir-s3-cdn-cf.behance.net/project_modules/fs_webp/baa953214380481.675743f08b86f.jpeg'],
      description: { en: 'Expert Logo demonstrates simplicity and artistic customer touches', ar: 'تصميم احترافي يتميز بالبساطة وتظهر فيه لمسات العميل' },
      tags: ['Ai/Ps', 'Brand', 'Logo Design'],
    },
    {
      id: 5,
      title: { en: 'Logo Brand & Identity For Kahraman & Zapheer Jewels Co.', ar: 'شعار وهوية بصرية لشركة مجوهرات كهرمان وزفير' },
      category: 'branding',
      image: ['https://mir-s3-cdn-cf.behance.net/project_modules/fs_webp/699a54214380481.675743f087224.jpeg'],
      description: { en: 'Luxury medical brand visual identity', ar: 'هوية بصرية فاخرة لعلامة طبية' },
    ...
    },
    {
      ...
      category: 'branding',
      image: ['https://mir-s3-cdn-cf.behance.net/project_modules/fs_webp/9a450c214380481.675743f081bb3.jpeg'],
