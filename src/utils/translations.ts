...
export const translations = {
  ...
  ar: {
    ...
    // About
    aboutTitle: 'نبذة عني',
    aboutDescription: 'مصمم علامات تجارية وشعارات مبدع وذو خبرة في تطوير الهويات البصرية. ماهر في إدارة فرق التصميم وتعزيز التعاون وضمان التنفيذ الناجح للمشاريع الإبداعية.',
    experience: 'الخبرة',
    education: 'التعليم',
    skills: 'المهارات',
